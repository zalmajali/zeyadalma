...
export class NotifiComponent  implements OnInit {
  ...
  public select: any;
  public notifi: any;
  public notifi_one: any;
  public notifi_tow: any;
  public notifi_three: any;
  public notifi_for: any;
  public notifi_five: any;
  public notifi_six: any;
  //check login
  public fullName:any;
  public userId:any;
  public username:any;
  ...
  initialiseTranslation(){
    ...
    this.translate.get('notifi').subscribe((res: string) => {
      this.notifi = res;
    });
    this.translate.get('notifi_one').subscribe((res: string) => {
      this.notifi_one = res;
    });
    this.translate.get('notifi_tow').subscribe((res: string) => {
      this.notifi_tow = res;
    });
    this.translate.get('notifi_three').subscribe((res: string) => {
      this.notifi_three = res;
    });
    this.translate.get('notifi_for').subscribe((res: string) => {
      this.notifi_for = res;
    });
    this.translate.get('notifi_five').subscribe((res: string) => {
      this.notifi_five = res;
    });
    this.translate.get('notifi_six').subscribe((res: string) => {
      this.notifi_six = res;
    });
  }
  selectNotifi(event:any){

  }
  functionAddNotifiTask(){
